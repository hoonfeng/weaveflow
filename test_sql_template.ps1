...
try {
    $response = Invoke-WebRequest -Uri "http://localhost:8081/api/admin/test_sql_template?page=1&page_size=10" -Headers $headers -Method GET
    Write-Host "SQL Template Test Response: $($response.Content)"
} catch {
